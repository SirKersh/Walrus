...
/**
 * The KieManager manages the KieSession of the engine.
 * A KieSession contains all of the rules that are loaded into the engine. These rules are stored in an activeRules and inActiveRules list.
 * On startup the system loads the activeRules list into the KieSession for initial firing. 
 * 
 * @author Walrus
 *
 */
