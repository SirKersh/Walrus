...
public class RuleCreator {
	...
	private DataObjectCollectionArrayList list;
	private DataObjectCollectionArrayList newData;
	 ...
	 * @param directoryName
	 * @parm scan
	 * @parm DataObjectCollectionArrayList
	 */
	...
	public RuleCreator(String ruleName, String directoryName, Scanner Scan, DataObjectCollectionArrayList theList,DataObjectCollectionArrayList NewData) {
		list = theList;
		this.ruleName = ruleName;
		this.directoryName = directoryName;
		scan = Scan;
	 ...
	 * CreateRule uses RuleMaker's createRule() inorder to build the duplicated
	 * part of a .drl file
	 * 
	 * @throws IOException
	 */
	...
	public String createInnerRule() {
		...
		while (true) {
			...
			if(choice==2&&newData.howManyInCollection()==0){
				System.out.println("No new Data in the system. Automatically choosing option 1.");
				choice = 1;
			}
			else if(choice==1&&list.howManyInCollection()==0){
			...
			switch(choice)
			{
				case 1:
					...
					int howManyToPrint = list.howManyInCollection();
				...
				case 2:
					...
					int size = newData.howManyInCollection();
