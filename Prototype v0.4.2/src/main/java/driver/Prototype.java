...
public class Prototype {
	...
	public void updateOnce() throws IOException
	{
		...
		if (dataObjCol.size() > 0) {
			...
			//if(namesToFire.size()>0)
			//{
			//	System.out.println("Fire with Agenda");
			//	CustomAgendaFilter caf = new CustomAgendaFilter(namesToFire);
			//	kSession.fireAllRules(caf);
			//}
			//else
				kSession.fireAllRules();
			...
			System.out.println("No Logfile Selected.");
		//System.out.println("continueFiring: "+continueFiring);
		//}
